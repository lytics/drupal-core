...
export const ImpressionsGlobalTotal: Field = {
  ...
  label: "Hide after (number) of total impressions across all experiences?",
  description:
    "Only show to visitors who have seen fewer than the defined number of experiences across your site ever.",
  type: "number",
  method: "input",
  required: false,
  hidden: true,
...
export const ImpressionsGlobalSession: Field = {
  ...
  label: "Hide after (number) of session impressions across all experiences?",
  description:
    "Only show to visitors who have seen fewer than the defined number of experiences during the current session.",
  type: "number",
  method: "input",
  required: false,
  hidden: true,
...
export const ImpressionsWidgetTotal: Field = {
  ...
  label: "Hide after (number) of total impressions for this experience?",
  description:
    "Only show to visitors who have seen this experience fewer than the defined number times.",
  type: "number",
  method: "input",
  required: false,
  hidden: true,
...
export const ImpressionsWidgetSession: Field = {
  ...
  label: "Hide after (number) of session impressions for this experience?",
  description:
    "Only show to visitors who have seen this experience fewer than the defined number of times.",
  type: "number",
  method: "input",
  required: false,
  hidden: true,
...
export const ImpressionsWidgetDuration: Field = {
  ...
  label: "Reset impression count for this experience after (seconds)?",
  description:
    "Define the number of seconds which must elapse before resetting this experiences impression count.",
  type: "number",
  method: "input",
  required: false,
  hidden: true,
